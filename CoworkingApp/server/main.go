...
func seedData(db *gorm.DB) {
	...
	db.Create(&models.User{
		ID:       userId,
		Email:    "cristianomagrini@gmail.com",
		Username: "crimag",
		Password: "abc123!",
	})
	db.Create([]*models.Room{
		{
			...
			MainPhoto: "/green_0001.jpg", Photos: []models.Photo{
				{Url: "/green_0002.jpg"},
				{Url: "/green_0003.jpg"},
			},
		},
		{
			ID: utils.GetUuid(), Name: "Red", Cost: 100.00, NumberOfSeats: 50, Category: "Conference Hall",
			MainPhoto: "/red_0001.jpg", Photos: []models.Photo{
				{Url: "/red_0002.jpg"},
			},
		},
		{
			ID: utils.GetUuid(), Name: "Yellow", Cost: 4.50, NumberOfSeats: 1, Category: "Shared Desk",
			MainPhoto: "/yellow_0001.jpg", Photos: []models.Photo{
				{Url: "/yellow_0002.jpg"},
				{Url: "/yellow_0003.jpg"},
				{Url: "/yellow_0004.jpg"},
			},
